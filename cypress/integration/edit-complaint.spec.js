describe("Edit complaint", () => {
    ...
    it("edits a complaint", () => {
        ...
        cy.contains(".govuk-radios__label", "Major").parent().get("input").should("be.checked");
        ...
        cy.contains(".govuk-radios__label", "Correspondence").parent().get("input").should("be.checked");
