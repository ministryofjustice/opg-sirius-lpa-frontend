...
describe("Change trust corporation details form", () => {
  ...
  it("can edit all attorney details and redirect to lpa details", () => {
    ...
    cy.get(String.raw`#f-address\.Line1`)
      .clear()
      .type("12");
    cy.get(String.raw`#f-address\.Line2`)
      .clear()
      .type("Building");
    cy.get(String.raw`#f-address\.Line3`)
      .clear()
      .type("Road");
    cy.get(String.raw`#f-address\.Town`)
      .clear()
      .type("London");
    cy.get(String.raw`#f-address\.Postcode`)
      .clear()
      .type("E14 2SH");
