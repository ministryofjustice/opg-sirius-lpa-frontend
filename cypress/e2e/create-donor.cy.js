describe("Create donor", () => {
  ...
  it("creates a donor", () => {
    ...
    cy.get("#f-previouslyKnownAs").type("Colton Bacman");
    cy.get("#f-alsoKnownAs").type("Mel");
    ...
    cy.get("#f-researchOptOut-1").click();

    cy.get("button[type=submit]").click();
    cy.get(".govuk-notification-banner").should("exist");
    cy.get(".govuk-notification-banner").contains("Person 7000-0290-0192 was created");
  });
});
