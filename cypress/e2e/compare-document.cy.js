describe("Compare documents", () => {
  beforeEach(() => {
    // Mock the single document fetch by UUID
    cy.addMock(
    ...
    // Mock fetching all documents for the person filtered by case
    cy.addMock(
  ...
  it("compares documents for a person", () => {
    cy.visit("/compare/33/documents?uid[]=dfef6714-b4fe-44c2-b26e-90dfe3663e95");
    cy.contains("7001-0000-5678");
    cy.get('#main-content > :nth-child(1) > .govuk-button').contains('Back to list')
