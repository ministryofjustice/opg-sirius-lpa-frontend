...
describe("View a digital LPA", () => {
  beforeEach(() => {
    ...
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3333", "GET", lpaResponse,);
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3333?presignImages", "GET", lpaResponse,);
    ...
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3334", "GET", otherLpaResponse);
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3334?presignImages", "GET", otherLpaResponse);
    ...
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3336", "GET", paperLpaResponse);
    cy.addMock("/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3336?presignImages", "GET", paperLpaResponse);
