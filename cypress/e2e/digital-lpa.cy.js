describe("View a digital LPA", () => {
  beforeEach(() => {
    ...
    cy.addMock(`/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3333/progress-indicators`, "GET", {
      status: 200,
      body: {
    ...
    cy.addMock(`/lpa-api/v1/digital-lpas/M-DIGI-LPA3-3334/progress-indicators`, "GET", {
      status: 200,
      body: {
