describe("View LPA history timeline", () => {
    beforeEach(() => {
        cy.addMock(
            "/lpa-api/v1/persons/1/events?&sort=id:desc&limit=999",
            "GET",
            {
                status: 200,
                body: {
                    ...
                    events: [
                        ...
                        },
                        {
                            ...
                            entity: {
                                _class: "Opg\\Core\\Model\\Entity\\CaseItem\\PowerOfAttorney\\Lpa"
                            },
    ...
    it("can view variable footer content", () => {
        cy.get('.moj-timeline__item')
            ...
            .then(($items) => {
                ...
                expect(normalise($items[0]))
                    .to.include('Created by Marty Test (Casework Team) – 0300 300 0300')

                expect(normalise($items[1]))
                    .to.include('Updated by deleted user')

                expect(normalise($items[2]))
                    .to.include('Deleted by Team Less – 03001234567')
            })
    });
    ...
    it("can view variable case details content", () => {
        ...
        cy.get('.moj-timeline__item')
            ...
            .then(($items) => {
                ...
                cy.wrap($items.eq(3)).should('not.contain.text', 'EPA')
