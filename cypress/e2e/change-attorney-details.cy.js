describe("Change attorney details form", () => {
    beforeEach(() => {
        ...
        cy.addMock(
            "/lpa-api/v1/cases/555/tasks?filter=status%3ANot+started%2Cactive%3Atrue&limit=99&sort=duedate%3AASC", "GET",
            {
                status: 200,
                body: {
                    tasks: [],
    ...
    it("can be visited from the LPA details Change link", () => {
        cy.visit("/lpa/M-1111-1111-1110/lpa-details").then(() => {
            cy.get(".govuk-accordion__section-button").contains("Attorney").click();
