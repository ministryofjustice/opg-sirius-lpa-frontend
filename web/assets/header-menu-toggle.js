export default function toggleHeaderMenu() {
  ...
  if (headerContainer) {
    const menuButton = headerContainer.querySelector(
      '[data-module="app-header-menu-toggle"]',
    );
    const menuItemList = headerContainer.querySelector(
      '[data-id="app-header-menu-item-list"]',
    );
