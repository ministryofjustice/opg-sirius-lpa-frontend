...
func TestGetCompareDocsPanes(t *testing.T) {
		...
		},
	{
		...
		closeURLToDocumentPanel2: "/view-document/doc1-uuid?pane=1",
	},
	{
		...
		getDocuments:             []sirius.Document{document1},
		closeURLToDocumentPanel1: "/view-document/doc1-uuid?pane=2",
	...
	},
	{
		...
		view1: &viewingDocumentData{
			...
			CloseURL: "/view-document/doc2-uuid?pane=2",
		},
		view2: &viewingDocumentData{
			Document: document2,
			Pane:     2,
			BackURL:  "/compare/77/456?pane1=doc1-uuid",
			CloseURL: "/view-document/doc1-uuid?pane=1",
		},
		compareURLs1: map[string]string{
