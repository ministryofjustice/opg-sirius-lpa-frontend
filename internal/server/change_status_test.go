...
func (m *mockChangeStatusClient) GetAvailableStatuses(ctx sirius.Context, caseID int, caseType sirius.CaseType) ([]string, error) {
...
func TestGetChangeStatus(t *testing.T) {
	for _, caseType := range []string{"lpa", "epa"} {
		t.Run(caseType, func(t *testing.T) {
			...
			client.
				On("GetAvailableStatuses", mock.Anything, 123, sirius.CaseType(caseType)).
...
func TestGetChangeStatusWhenAvailableStatusesErrors(t *testing.T) {
	...
	client.
		On("GetAvailableStatuses", mock.Anything, 123, sirius.CaseTypeLpa).
